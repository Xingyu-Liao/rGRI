...
class MultipleAlignmentThreads_Ref implements Runnable{
	int index=0;
	int thread=0;
	String alignTool="";
	String homePath="";
	String filePath="";
	String kmerFile="";
	public MultipleAlignmentThreads_Ref(int Index, String HomePath, String FilePath, String KmerFile, int Threads)
	{
		index=Index;
		thread=Threads;
		filePath=FilePath;
